...
async function deleteCurrentUser() {
  try {
    const userEmail = 'Thabang.Nkabinde@khonology.com';
    ...
    console.log('Are you sure you want to delete this user? (yes/no)');
    
    // For script automation, we'll proceed with deletion
