-- =====================================================
-- DELIVERABLE & SPRINT SIGN-OFF HUB - COMPLETE DATABASE SCHEMA
-- =====================================================
-- This schema supports all screens and functionality in the application
-- Created for: Flow-Space Flutter Application
-- Version: 1.0
-- =====================================================
...
-- Sprint metrics table (from sprint_metrics_screen.dart)
...
-- Deliverables table (from enhanced_deliverable_setup_screen.dart)
...
CREATE TABLE deliverable_dod_items (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Sprint-Deliverable relationships (many-to-many)
...
CREATE TABLE release_readiness_checks (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    deliverable_id UUID NOT NULL REFERENCES deliverables(id) ON DELETE CASCADE,
...
-- Sign-off reports (from report_builder_screen.dart)
...
-- Client reviews (from enhanced_client_review_screen.dart)
...
-- Notifications (from notification_center_screen.dart)
...
CREATE TABLE activity_logs (
    ...
    entity_type VARCHAR(50) NOT NULL, -- 'deliverable', 'sprint', 'report', etc.
    entity_id UUID NOT NULL,
    action VARCHAR(100) NOT NULL, -- 'created', 'updated', 'approved', etc.
    description TEXT,
    old_values JSONB,
    new_values JSONB,
    ip_address INET,
...
-- =====================================================
-- 10. REPOSITORY & FILE MANAGEMENT
-- =====================================================

-- Repository files (from repository_screen.dart)
...
-- Approval requests (from approvals_screen.dart)
CREATE TABLE approval_requests (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    entity_type VARCHAR(50) NOT NULL, -- 'deliverable', 'report', etc.
    entity_id UUID NOT NULL,
...
CREATE INDEX idx_sprint_metrics_recorded_at ON sprint_metrics(recorded_at);
...
CREATE INDEX idx_sign_off_reports_status ON sign_off_reports(status);
CREATE INDEX idx_sign_off_reports_created_by ON sign_off_reports(created_by);
...
('00000000-0000-0000-0000-000000000001', 'john.doe@company.com', '$2b$12$hash1', 'John', 'Doe', 'TechCorp', 'project_manager'),
('00000000-0000-0000-0000-000000000002', 'jane.smith@company.com', '$2b$12$hash2', 'Jane', 'Smith', 'TechCorp', 'developer'),
('00000000-0000-0000-0000-000000000003', 'client@clientcompany.com', '$2b$12$hash3', 'Client', 'User', 'ClientCorp', 'client');

-- Insert sample project
INSERT INTO projects (id, name, description, created_by) VALUES
('00000000-0000-0000-0000-000000000100', 'Authentication System', 'User authentication and authorization system', '00000000-0000-0000-0000-000000000001');
...
('00000000-0000-0000-0000-000000000100', '00000000-0000-0000-0000-000000000003', 'viewer');

-- =====================================================
-- 15. VIEWS FOR COMMON QUERIES
-- =====================================================

-- View for deliverable summary with sprint information
CREATE VIEW deliverable_summary AS
SELECT 
    d.id,
    d.title,
    d.description,
...
CREATE VIEW sprint_performance_summary AS
SELECT 
    s.id,
    s.name,
    s.start_date,
