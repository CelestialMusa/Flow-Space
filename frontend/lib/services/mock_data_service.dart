  ...
  static List<Deliverable> getMockDeliverables() {
    ...
    return [
      Deliverable(
        ...
        sprintIds: ['1'],
        definitionOfDone: [
          DoDItem(text: 'Unit tests written with >90% coverage'),
          DoDItem(text: 'Integration tests passing'),
          DoDItem(text: 'Security review completed'),
          DoDItem(text: 'Documentation updated'),
        ],
      ...
      Deliverable(
        ...
        sprintIds: ['2'],
        definitionOfDone: [
          DoDItem(text: 'Design system implemented'),
          DoDItem(text: 'All screen sizes tested'),
          DoDItem(text: 'Performance optimized'),
          DoDItem(text: 'Accessibility compliant'),
        ],
      ...
      Deliverable(
        ...
        sprintIds: ['2'],
        definitionOfDone: [
          DoDItem(text: 'API endpoints tested'),
          DoDItem(text: 'Load testing completed'),
          DoDItem(text: 'Error handling verified'),
          DoDItem(text: 'Documentation complete'),
        ],
        evidenceLinks: [],
      ),
    ];
